window.SubmissionCSVWarnings = {};

var warnings = [];
var visibleWarnings = [];

SubmissionCSVWarnings.addWarning = function(warningType) {
  if (!warnings.includes(warningType)) {
    warnings.push(warningType);
  }
  SubmissionCSVWarnings.showWarnings();
};

SubmissionCSVWarnings.showWarnings = function() {
...
SubmissionCSVWarnings.clearWarnings = function() {
  warnings = [];
  visibleWarnings = [];
  var warningDiv = $('#warning-messages');
